function [R_i,dRi,rj] = Recursive_position_PATU(phi,dphi,param_bod)
...
dRi(:,1) = [ - dphi1*param_bod.u1_bar_j1_o1y*cos(phi1) - dphi1*param_bod.u1_bar_j1_o1x*sin(phi1);
               dphi1*param_bod.u1_bar_j1_o1x*cos(phi1) - dphi1*param_bod.u1_bar_j1_o1y*sin(phi1)];        
dRi(:,2) = [ - dphi1*param_bod.u1_bar_j1_j2y*cos(phi1) - dphi2*param_bod.u2_bar_j2_o2y*cos(phi2) - dphi1*param_bod.u1_bar_j1_j2x*sin(phi1) - dphi2*param_bod.u2_bar_j2_o2x*sin(phi2);
               dphi1*param_bod.u1_bar_j1_j2x*cos(phi1) + dphi2*param_bod.u2_bar_j2_o2x*cos(phi2) - dphi1*param_bod.u1_bar_j1_j2y*sin(phi1) - dphi2*param_bod.u2_bar_j2_o2y*sin(phi2)];
dRi(:,3) = [ - dphi1*param_bod.u1_bar_j1_j2y*cos(phi1) - dphi2*param_bod.u2_bar_j2_j3y*cos(phi2) - dphi3*param_bod.u3_bar_j3_o3y*cos(phi3) - dphi1*param_bod.u1_bar_j1_j2x*sin(phi1) - dphi2*param_bod.u2_bar_j2_j3x*sin(phi2) - dphi3*param_bod.u3_bar_j3_o3x*sin(phi3);
               dphi1*param_bod.u1_bar_j1_j2x*cos(phi1) + dphi2*param_bod.u2_bar_j2_j3x*cos(phi2) + dphi3*param_bod.u3_bar_j3_o3x*cos(phi3) - dphi1*param_bod.u1_bar_j1_j2y*sin(phi1) - dphi2*param_bod.u2_bar_j2_j3y*sin(phi2) - dphi3*param_bod.u3_bar_j3_o3y*sin(phi3)];
dRi(:,4) = [ - dphi1*param_bod.u1_bar_j1_j4y*cos(phi1) - dphi4*param_bod.u4_bar_j4_o4y*cos(phi4) - dphi1*param_bod.u1_bar_j1_j4x*sin(phi1) - dphi4*param_bod.u4_bar_j4_o4x*sin(phi4);
               dphi1*param_bod.u1_bar_j1_j4x*cos(phi1) + dphi4*param_bod.u4_bar_j4_o4x*cos(phi4) - dphi1*param_bod.u1_bar_j1_j4y*sin(phi1) - dphi4*param_bod.u4_bar_j4_o4y*sin(phi4)];
